...
public class Main {
    ...
    static void printMenu(){
        System.out.println("1) Reading the data in the file and creating the relevant data structures.\n" +
                "2) Entry of a new customer from the keyboard \n" +
                "3) Print the average rating score for each product.\n" +
                "4) Print by calculating the average rating score for each product,\n" +
                "taking into account only customers whose country is \"Turkey\".\n" +
                "5) Print by calculating the average rating score for each product,\n" +
                "taking into account customers whose country is other than \"Turkey\".\n" +
                "6) Print by calculating the average rating score for each product,\n" +
                "taking into account only customers whose profession is Doctor.\n" +
                "7) Print the customer information linked list from start to finish.\n" +
                "8) Print a two-dimensional array to the screen.\n"+
                "0) Exit"
        );
    }
}